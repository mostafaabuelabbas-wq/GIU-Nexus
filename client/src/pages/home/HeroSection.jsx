...
const FRAMES = [
  { bg:'#2F4A2E', tag:'// studio · cairo', num:'٠١', baseT:'rotate(-4deg)', cls:'left-0 top-[3%] w-[57%] h-[45%]',          img:'/photos/photo1.jpg' },
  { bg:'#EE5688', tag:'// portrait',        num:'٠٢', baseT:'rotate(2deg)',  cls:'right-[4%] top-0 w-[46%] h-[38%]',         img:'/photos/photo2.jpg' },
  { bg:'#E5A93A', tag:'// on campus',       num:'٠٣', baseT:'rotate(-5deg)', cls:'left-[20%] top-[36%] w-[52%] h-[38%]',    img:'/photos/photo3.jpg' },
  { bg:'#161310', tag:'// interface',       num:'٠٤', baseT:'rotate(3deg)',  cls:'right-[1%] top-[46%] w-[44%] h-[40%]',    img:'/photos/photo4.jpg' },
  { bg:'#E96A3A', tag:'// team',            num:'٠٥', baseT:'rotate(-1deg)', cls:'left-[2%] bottom-[6%] w-[45%] h-[33%]',   img:'/photos/photo5.jpg' },
  { bg:'#EE5688', tag:'// candid',          num:'٠٦', baseT:'rotate(6deg)',  cls:'right-0 bottom-0 w-[52%] h-[36%]',         img:'/photos/photo6.jpg' },
]
...
export default function HeroSection({ primaryCta }) {
  ...
  return (
    <section className="max-w-[1360px] mx-auto px-10 pt-16 pb-10">
      ...
      {/* ── Hero grid ── */}
      <div className="grid grid-cols-[1.05fr_0.95fr] gap-12 items-start">
        <div>
        ...
        {/* ── Collage ── */}
        <div ref={collageRef} className="relative h-full min-h-[640px]" aria-hidden="true">
          {FRAMES.map(f => (
            <div key={f.num} data-frame data-base-t={f.baseT}
              ...
              {f.img && <img src={f.img} alt="" className="absolute inset-0 w-full h-full object-cover" />}
