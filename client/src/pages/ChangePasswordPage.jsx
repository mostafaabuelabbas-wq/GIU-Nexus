...
export default function ChangePasswordPage() {
  ...
  const fields = [
    { name: 'currentPassword', label: 'Current password', ph: '••••••••', showToggle: true },
  ...
  return (
    <div className="min-h-screen bg-[#F1EAD9] flex flex-col">
      ...
      <main className="flex-1 max-w-lg w-full mx-auto px-6 py-12">
        ...
        <h1 className="font-['Space_Grotesk'] font-bold text-[30px] text-[#161310] leading-tight mb-2">Change your password.</h1>
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex gap-3 pt-2">
              <button type="submit" disabled={loading || success}
                ...
                {loading ? <><span className="w-4 h-4 rounded-full border-2 border-white border-t-transparent animate-spin inline-block" /> Updating…</> : 'Update password →'}
              </button>
              <Link to="/profile"
